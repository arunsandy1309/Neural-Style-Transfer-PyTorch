...
if __name__ == "__main__":
    ...
    parser.add_argument("--style_image", type=str, default="images/styles/illusion.jpg", help="path to style image")
    ...
    parser.add_argument("--sample_interval", type=int, default=50, help="Batches between saving image samples")
